# From https://github.com/tbekolay/phd
import nengo
...
def AuditoryPeriphery(freqs, sound_process, auditory_filter, neurons_per_freq=12, fs=50000., adaptive_neurons=False, net=None):
    if net is None:
    ...
    with net:
        ...
        net.fb = AuditoryFilterBank(freqs, sound_process, filterbank=auditory_filter, samplerate=fs)
        ...
        net.an = nengo.networks.EnsembleArray(neurons_per_freq, freqs.size,intercepts=Uniform(-0.1, 0.5), encoders=Choice([[1]]), neuron_type=neuron_type)
